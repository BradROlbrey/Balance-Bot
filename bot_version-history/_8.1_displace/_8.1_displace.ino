...
// Bot stuff
int gyro_prop = 33; // proportional of gyro
float gyro_diff = 2; // differential of gyro
int vari_prop = 5; // proportional of variance
int vari_diff = 5; // differential of variance
int disp_prop = 30; // proportional of displacement
float disp_diff = 1; // differential of displacement
...
/*********** Bluetooth stuff ***********/
  ...
  // if we have a central, and we are connected
    ...
    if (Disp_Diff.written())
      disp_diff = (float) Disp_Diff.value() / 10 + 1;
